...
const fetchPaymentsWorkspace = unstable_cache(
  async (): Promise<PaymentsWorkspaceProject[]> => {
  ...
  ["payments-workspace"],
  { tags: [cacheTags.paymentsWorkspace], revalidate: 60 }
);

export const listPaymentsWorkspaceProjects = cache(fetchPaymentsWorkspace);
